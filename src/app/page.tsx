...
// //   return (
// //     <div className='flex h-screen w-full overflow-hidden bg-gradient-to-tr from-gray-100 to-slate-200 text-[#1e293b]'>
// //       {/* Sidebar */}
// //       <Sidebar
...
// //           <div className='rounded-2xl bg-white/70 backdrop-blur-sm shadow-xl p-6 sm:p-8 min-h-[80vh]'>
...
// import Humanizer from './components/Humanizer';
// import Sidebar from './components/Sidebar';
// import BlogTable from './components/Humanizer'; // Import BlogTable directly
...
//         <main className='flex-1 p-6 sm:p-10 transition-all'>
//           {/* Conditionally render without the additional container for BlogTable */}
//           {activeSection === 'home' && (
//             <BlogTable theme={theme} setTheme={setTheme} />
//           )}

//           {/* Use container for other components */}
//           {activeSection !== 'home' && (
//             <div
